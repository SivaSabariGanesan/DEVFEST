...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-black flex items-start md:items-center justify-center pt-16 md:pt-0">
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center md:text-left space-y-8 md:space-y-0">
          <div className="relative inline-block">
            <h1
              ref={titleRef}
              className="font-black text-6xl sm:text-7xl md:text-7xl lg:text-8xl xl:text-9xl leading-none md:leading-tight"
            >
            ...
            {[0, 1].map((index) => (
              ...
              >
                <span className="font-black text-6xl sm:text-7xl md:text-7xl lg:text-8xl xl:text-9xl leading-none md:leading-tight opacity-50">
                  <span className="md:hidden">
                    DEV
                    <br />
                    FEST
