...
import image from "../components/devs.png"
  ...
  return (
    <>
      <div className="relative m-0 p-0">
        <div
          id="intro-slider"
          className="m-0 p-0 absolute h-screen w-full flex flex-col justify-center items-center bg-[#eee] z-20 border-b-2 border-[#c3ff00]"
        >
