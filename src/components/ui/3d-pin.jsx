      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            ...
            className="relative flex space-x-2 items-center z-10 rounded-lg  py-0.5 px-4 ring-1 ring-white/10 ">
            <span
              className="relative z-20 uppercase text-black text-sm inline-block py-0.5">
              {title}
            </span>
