      ...
      <div className="group relative bg-yellow-300 transition-all duration-500 h-16 md:h-18 border-b-2 border-white">
        <div className="flex justify-between items-center h-full px-4 md:px-8">
          ...
          <div className="text-lg md:text-3xl transition-transform duration-300 z-10 group-hover:translate-x-5 group-hover:text-black group-hover:scale-90">
            {number} <span className="mx-4 md:mx-8">{children}</span>
          </div>
          <div className="text-lg md:text-3xl transition-transform duration-300 z-10 group-hover:translate-x-5 group-hover:text-black group-hover:scale-90">
            {type}
          </div>
          {/* Icon */}
          <div className="icon transition-transform duration-200 z-10 group-hover:-translate-x-5 group-hover:-rotate-45 rounded-full bg-white w-6 h-6 md:w-8 md:h-8 flex justify-center items-center group-hover:scale-90 group-hover:border-none group-hover:bg-transparent">
